...
namespace Spans
{
    class Program
    {
        ...
        static void BubbleSort<T>(MySpan<T> list) where T : IComparable
        {
            bool madeChanges;
            int itemCount = list.Length;
            do
        ...
        static void BubbleSort<T>(Span<T> list) where T : IComparable
        {
            bool madeChanges;
            int itemCount = list.Length;
            do
        ...
        static void Print<T>(Span<T> list) => Print(list.ToArray());
        #endregion
    }
}
