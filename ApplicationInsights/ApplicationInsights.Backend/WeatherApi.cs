...
class WeatherApi
{
    ...
    public WeatherApi(IHttpClientFactory factory, IConfiguration config)
    {
    ...
    public async Task<string> GetCurrentWeather(string city)
    {
        ...
        return $"The current weather in {weatherData.Location.Name} is {weatherData.Current.Condition.Text} with a temperature of {weatherData.Current.Temperature}°C and a wind speed of {weatherData.Current.WindSpeed} km/h.";
    }
}
