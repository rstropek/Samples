...
// Create a private DNS zone for the private link to Azure OpenAI
resource privateDnsZoneSearch 'Microsoft.Network/privateDnsZones@2024-06-01' = {
...
// Link the private DNS zone to the virtual network
resource privateDnsZoneSearchLink 'Microsoft.Network/privateDnsZones/virtualNetworkLinks@2024-06-01' = {
  parent: privateDnsZoneSearch
  name: '${privateDnsZoneSearch.name}-link'
  location: 'global'
  properties: {
    registrationEnabled: false
    virtualNetwork: {
...
output privateDnsZoneSearchId string = privateDnsZoneSearch.id
